...
1. [The Rules of JSX](#the-rules-of-jsx)
    - [1. Return a single root element](#1-return-a-single-root-element)
    - [2. Close all the tags](#2-close-all-the-tags)
    - [3. camelCase](#3-camelcase)
...
```
- This is because JSX is stricter and has a few more rules than HTML!
    - If you read the error messages above, they’ll guide you to fix the markup, or you can follow the guide below.
> NOTE
...
> For historical reasons, [aria-*](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA) and [data-*](https://developer.mozilla.org/en-US/docs/Learn/HTML/Howto/Use_data_attributes) attributes are written as in HTML with dashes.

#### Pro-tip: Use a JSX Converter
- Converting all these attributes in existing markup can be tedious!
    - We recommend using a converter to translate your existing HTML and SVG to JSX.
